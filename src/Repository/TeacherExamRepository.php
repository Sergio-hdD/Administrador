...
/**
 * @extends ServiceEntityRepository<TeacherExam>
 *
...
class TeacherExamRepository extends ServiceEntityRepository
{
    ...
    public function add(TeacherExam $entity, bool $flush = false): void
    {
    ...
    public function remove(TeacherExam $entity, bool $flush = false): void
    {
